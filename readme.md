...
Un fichier excel additionel recensant tout les occurence du champ recherché sera ajouté avec les metadonnées lié au fichier.
...
Pour utiliser le logiciel il suffit d'éxécuter le fichier run.bat et de saisir le champ de recherche souhaité.
